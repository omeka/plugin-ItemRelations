<div class="field">
    ...
    <div class="inputs">
        ...
        <p class="explanation">Filter by items with the selected relation. For
        example, when selecting "Subject" items with the "hasPart" relation, the
        search will return all items that have parts. When selecting "Object"
        items with the "hasPart" relation, the search will return all items that
        parts of other items.</p>
    </div>
</div>