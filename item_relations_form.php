    ...
    <tbody>
      <?php foreach ($subjectRelations as $subjectRelation): ?>
        ...
        <div id="item-relation-selector" style="overflow: auto; padding: 20px; border-radius: 6px; background: #fff" class="lity-hide">
          ...
          <link href="<?php echo css_src('lity.min', 'javascripts/lity'); ?>" rel="stylesheet">
          <link href="<?php echo css_src('item-relations'); ?>" rel="stylesheet">
          <?php echo js_tag('lity.min', $dir = 'javascripts/lity'); ?>
          <script type="text/javascript">var url = '<?php echo url('item-relations/lookup/'); ?>'; </script>
          <?php echo js_tag('item-relations'); ?>
